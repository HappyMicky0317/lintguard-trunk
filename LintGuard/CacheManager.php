...
use LintGuard\CacheInterface;
use LintGuard\CacheEntry;
use function LintGuard\getVersion;
use function LintGuard\Cli\getDebug;
...
class CacheManager {
	...
	public function __construct(CliOptions $options, CacheInterface $cache) {
		$this->cache = $cache;
		$this->debug = getDebug($options);
	}
